...
var lt, w, Dn, Te, Sr, Cn, Xe = {}, Rn = [], ii = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function K(t, e) {
  for (var r in e)
    t[r] = e[r];
  return t;
...
function _n(t, e, r, n, a, i, o, s, l, c) {
  ...
  for (r.__k = [], u = 0; u < e.length; u++)
    if ((d = r.__k[u] = (d = e[u]) == null || typeof d == "boolean" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? qe(null, d, null, null, d) : Array.isArray(d) ? qe(te, { children: d }, null, null, null) : d.__b > 0 ? qe(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null) {
      ...
      jt(t, d, v = v || Xe, a, i, o, s, l, c), p = d.__e, (f = d.ref) && v.ref != f && (S || (S = []), v.ref && S.push(v.ref, null, d), S.push(f, d.__c || p, d)), p != null ? (E == null && (E = p), typeof d.type == "function" && d.__k === v.__k ? d.__d = l = Mn(d, l, t) : l = kn(t, d, v, g, p, l), typeof r.type == "function" && (r.__d = l)) : l && v.__e == l && l.parentNode != t && (l = me(v));
    }
  for (r.__e = E, u = b; u--; )
    g[u] != null && (typeof r.type == "function" && g[u].__e != null && g[u].__e == r.__d && (r.__d = me(n, u + 1)), Hn(g[u], g[u]));
  if (S)
...
function jt(t, e, r, n, a, i, o, s, l) {
  var c, u, f, v, d, p, E, S, g, b, D, C, k, T = e.type;
  if (e.constructor !== void 0)
    return null;
  r.__h != null && (l = r.__h, s = e.__e = r.__e, e.__h = null, i = [s]), (c = w.__b) && c(e);
  try {
    e:
      if (typeof T == "function") {
        if (S = e.props, g = (c = T.contextType) && n[c.__c], b = c ? g ? g.props.value : c.__ : n, r.__c ? E = (u = e.__c = r.__c).__ = u.__E : ("prototype" in T && T.prototype.render ? e.__c = u = new T(S, b) : (e.__c = u = new q(S, b), u.constructor = T, u.render = ui), g && g.sub(u), u.props = S, u.state || (u.state = {}), u.context = b, u.__n = n, f = u.__d = !0, u.__h = []), u.__s == null && (u.__s = u.state), T.getDerivedStateFromProps != null && (u.__s == u.state && (u.__s = K({}, u.__s)), K(u.__s, T.getDerivedStateFromProps(S, u.__s))), v = u.props, d = u.state, f)
          ...
          if (T.getDerivedStateFromProps == null && S !== v && u.componentWillReceiveProps != null && u.componentWillReceiveProps(S, b), !u.__e && u.shouldComponentUpdate != null && u.shouldComponentUpdate(S, u.__s, b) === !1 || e.__v === r.__v) {
            u.props = S, u.state = u.__s, e.__v !== r.__v && (u.__d = !1), u.__v = e, e.__e = r.__e, e.__k = r.__k, e.__k.forEach(function(P) {
              P && (P.__ = e);
        ...
        if (u.context = b, u.props = S, u.__v = e, u.__P = t, D = w.__r, C = 0, "prototype" in T && T.prototype.render)
          u.state = u.__s, u.__d = !1, D && D(e), c = u.render(u.props, u.state, u.context);
        else
          do
            u.__d = !1, D && D(e), c = u.render(u.props, u.state, u.context), u.state = u.__s;
          while (u.__d && ++C < 25);
        u.state = u.__s, u.getChildContext != null && (n = K(K({}, n), u.getChildContext())), f || u.getSnapshotBeforeUpdate == null || (p = u.getSnapshotBeforeUpdate(v, d)), k = c != null && c.type === te && c.key == null ? c.props.children : c, _n(t, Array.isArray(k) ? k : [k], e, r, n, a, i, o, s, l), u.base = e.__e, e.__h = null, u.__h.length && o.push(u), E && (u.__E = u.__ = null), u.__e = !1;
      } else
...
function li(t, e, r, n, a, i, o, s) {
  ...
  if (d === null)
    ...
    if (si(t, v, f, a, s), u)
      e.__k = [];
    else if (p = e.props.children, _n(t, Array.isArray(p) ? p : [p], e, r, n, a && d !== "foreignObject", i, o, i ? i[0] : r.__k && me(r, 0), s), i != null)
      for (p = i.length; p--; )
        i[p] != null && wn(i[p]);
...
function He(t, e, r) {
  var n, a, i;
  w.__ && w.__(t, e), a = (n = typeof r == "function") ? null : r && r.__k || e.__k, i = [], jt(e, t = (!n && r || e).__k = ee(te, null, [t]), a || Xe, Xe, e.ownerSVGElement !== void 0, !n && r ? [r] : a ? null : e.firstChild ? lt.call(e.childNodes) : null, i, !n && r ? r : a ? a.__e : e.firstChild, n), In(i, t);
}
function ci(t, e) {
...
}, q.prototype.render = te, Te = [], $e.__r = 0, Cn = 0;
...
w.__b = function(t) {
  typeof t.type != "function" || t.o || t.type === te ? t.o || (t.o = t.__ && t.__.o ? t.__.o : "") : t.o = (t.__ && t.__.o ? t.__.o : "") + (t.__ && t.__.__k ? t.__.__k.indexOf(t) : 0), j = null, wr && wr(t);
}, w.__r = function(t) {
  Tr && Tr(t);
  var e = (j = t.__c).__H;
  ...
  _r && _r(t);
  var e = t.__c;
  e && e.__H && (e.__H.__h.length && (xn.push(e) !== 1 && Rr === w.requestAnimationFrame || ((Rr = w.requestAnimationFrame) || di)(fi)), e.__H.__.forEach(function(r) {
...
w.unmount = function(t) {
  ...
  var a = e.__a && ee(te, null, t.fallback);
  return a && (a.__h = null), [ee(te, null, e.__a ? null : t.children), a];
};
...
function wi(t) {
  ...
  for (w.debounceRendering = n, He(ee(Ti, {}), document.createElement("div")); r.length; )
    r.shift()();
...
function Ct(t, e, r, n) {
  var a = F([e, 0, 1 + io(e, r, n)]), i = H(t), o = Math.round(De(a, i));
...
function pe(t, e, r, n) {
  return n === "year" ? I(r.diffWholeYears(t, e), "year") : n === "month" ? I(r.diffWholeMonths(t, e), "month") : Qi(t, e);
}
function zo(t, e) {
  var r = null, n = null;
...
function nn(t, e, r, n) {
  ...
  for (var u in i)
    for (var D = i[u], C = rn(D, r), _ = 0, O = C; _ < O.length; _++) {
      var P = O[_];
      s.push({
        def: t.defs[u],
        ui: c[u],
...
var hs = function() {
  ...
  return t.prototype.getCurrentData = function() {
    ...
    var a = this.getCurrentData(), i = ts(n, a.dateEnv, I({ days: 1 }));
    ...
    var c = Zn(e, s, o, !1);
    if (c) {
      var u = new N(o, c.def, c.def.recurringDef ? null : c.instance);
...
function se(t, e, r) {
  ...
  for (var s in a) {
    ...
    l.instanceId !== o && i.push(new N(e, c, l));
  }
  return i;
}
var sa = {};
...
function pa(t, e, r, n) {
  return {
    dow: t.getUTCDay(),
    isDisabled: Boolean(n && !oe(n.activeRange, t)),
    isOther: Boolean(n && !oe(n.currentRange, t)),
    isToday: Boolean(e && oe(e, t)),
...
function cr(t, e, r, n) {
  ...
  if (i.navLinks) {
    ...
    return h({ title: Me(i.navLinkHint, [s, l], s), "data-navlink": "" }, n ? Fn(c) : { onClick: c });
  }
  return { "aria-label": s };
}
var _t = null;
...
function Xs(t, e, r, n, a, i, o, s, l, c, u, f, v) {
  return {
    ...
    createScrollResponder: function(d) {
      return new Zs(d, c, I(r.scrollTime), r.scrollTimeReset);
    },
...
function Qs() {
  var t = [], e = [], r;
  return function(n, a) {
    return (!r || !Ee(n, t) || !Ee(a, e)) && (r = Js(n, a)), t = n, e = a, r;
  };
}
function el(t, e) {
  return {
  ...
  return function(e) {
    return m(fe.Consumer, null, function(r) {
      return m(zt, { viewSpec: r.viewSpec }, function(n, a) {
        ...
        return m(Re, { hookProps: i, classNames: t.classNames, content: t.content, didMount: t.didMount, willUnmount: t.willUnmount, elRef: n }, function(o, s, l, c) {
...
function bl(t, e, r, n, a, i) {
  if (e && r === e.latestFetchId) {
    ...
    return n && (o = ye(o, n, i)), ar(_a(t, e.sourceId), o);
  }
  return t;
}
function Dl(t, e, r) {
  ...
  var o = e.direction === "rtl", s = e.customButtons || {}, l = r.buttonText || {}, c = e.buttonText || {}, u = r.buttonHints || {}, f = e.buttonHints || {}, v = t ? t.split(" ") : [], d = [], p = !1, E = v.map(function(S) {
    return S.split(",").map(function(g) {
      ...
      if (b = s[g])
        ...
        if (C = function() {
          i[g]();
        }, (T = l[g]) || (k = n.getIconClass(g, o)) || (T = c[g]), g === "prevYear" || g === "nextYear") {
...
var ka = function() {
  ...
  return t.prototype.resetOptions = function(e, r) {
    ...
    this.data && this.data.dateProfileGenerator !== c.dateProfileGenerator && (v = c.dateProfileGenerator.build(f)), f = vs(f, e), v = fl(v, e, f, c.dateProfileGenerator), (e.type === "PREV" || e.type === "NEXT" || !oe(v.currentRange, f)) && (f = v.currentRange.start);
    for (var d = vl(a.eventSources, e, v, u), p = Sl(a.eventStore, e, d, v, u), E = Da(d), S = E && !c.options.progressiveEventRendering && a.renderableEventStore || p, g = this.buildViewUiProps(u), b = g.eventUiSingleBase, D = g.selectionConfig, C = this.buildEventUiBySource(d), k = this.buildEventUiBases(S.defs, b, C), T = {
    ...
    }, P = h(h({}, u), T), _ = 0, O = s.pluginHooks.reducers; _ < O.length; _++) {
      var L = O[_];
      h(T, L(a, e, P));
    }
    var Z = kt(a, u), z = kt(T, u);
    ...
    for (var g in v)
      g !== "plugins" && (v[g] === p[g] || ae[g] && g in p && ae[g](p[g], v[g]) ? d[g] = E[g] : u[g] ? (d[g] = u[g](v[g]), S = !0) : f[g] = p[g]);
    ...
    for (var d in o)
      o[d] === c[d] || ae[d] && ae[d](o[d], c[d]) ? l[d] = u[d] : (o[d] === this.currentCalendarOptionsInput[d] || ae[d] && ae[d](o[d], this.currentCalendarOptionsInput[d]) ? d in this.currentCalendarOptionsRefined && (l[d] = this.currentCalendarOptionsRefined[d]) : s[d] ? l[d] = s[d](o[d]) : v[d] = o[d], f = !0);
...
function ru(t, e) {
  var r = e.themeClasses[t.themeSystem] || ne;
  return new r(t);
}
function nu(t) {
  ...
  return t.prototype.addSegs = function(e) {
    ...
    for (var r = this, n = r.levelCoords, a = r.entriesByLevel, i = r.strictOrder, o = r.stackCnts, s = n.length, l = 0, c = -1, u = -1, f = null, v = 0, d = 0; d < s; d += 1) {
      ...
      for (var E = a[d], S = void 0, g = hn(E, e.span.start, pn), b = g[0] + g[1]; (S = E[b]) && S.span.start < e.span.end; ) {
        var D = p + S.thickness;
        D > l && (l = D, f = S, c = d, u = b), D === l && (v = Math.max(v, o[Pe(S)] + 1)), b += 1;
      }
    }
    var C = 0;
    if (f)
...
var Su = function(t) {
  ...
  return e.prototype.render = function() {
    ...
    return m(Re, { hookProps: p, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: xa, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount }, function(E, S, g, b) {
      return m(
        "th",
  ...
  return e.prototype.render = function() {
    ...
    return m(Re, { hookProps: v, classNames: s.dayHeaderClassNames, content: s.dayHeaderContent, defaultContent: xa, didMount: s.dayHeaderDidMount, willUnmount: s.dayHeaderWillUnmount }, function(d, p, E, S) {
      return m(
        "th",
...
var wu = function() {
  ...
  return t.prototype.sliceProps = function(e, r, n, a) {
    ...
    if (!e)
      return [];
    for (var o = os(e, r, n), s = this.sliceRange.apply(this, A([e.range], a)), l = 0, c = s; l < c.length; l++) {
      var u = c[l];
      u.eventRange = o;
    }
    return s;
...
function Iu(t, e, r, n) {
  ...
  for (var p in l) {
    ...
    for (var _ = a.eventStore, O = 0, L = g.allows; O < L.length; O++) {
      var Z = L[O], z = h(h({}, r), { range: E.range, allDay: b.allDay }), Ue = _.defs[b.defId], Ve = _.instances[p], mt = void 0;
      if (Ue ? mt = new N(e, Ue, Ve) : mt = new N(e, b), !Z(sr(z, e), mt))
        return !1;
    }
  }
  return !0;
...
function Pu(t, e, r, n) {
  ...
  for (var v in o) {
    var d = o[v];
    if (or(l, d.range) && (c.overlap === !1 || f && !f(new N(e, i[d.defId], d), null)))
      return !1;
  }
...
var Va = function(t) {
  ...
  function e() {
    ...
    return r.processCols = M(function(n) {
      return n;
    }, Uu), r.renderMicroColGroup = M(Vu), r.scrollerRefs = new ie(), r.scrollerElRefs = new ie(r._handleScrollerEl.bind(r)), r.state = {
      shrinkWidth: null,
      forceYScrollbars: !1,
  ...
  return e.prototype.render = function() {
    ...
    }, Boolean(!S && d.length) && m.apply(void 0, A(["thead", g], d)), Boolean(!S && p.length) && m.apply(void 0, A(["tbody", g], p)), Boolean(!S && E.length) && m.apply(void 0, A(["tfoot", g], E)), S && m.apply(void 0, A(A(A(["tbody", g], d), p), E)));
...
var yr = function(t) {
  ...
  return e.prototype.render = function() {
    ...
    return m(Re, { hookProps: c, classNames: i.eventClassNames, content: i.eventContent, defaultContent: n.defaultContent, didMount: i.eventDidMount, willUnmount: i.eventWillUnmount, elRef: this.elRef }, function(f, v, d, p) {
...
var Qu = function(t) {
  return m(fe.Consumer, null, function(e) {
    ...
    return m(Re, { hookProps: l, classNames: n.weekNumberClassNames, content: n.weekNumberContent, defaultContent: ec, didMount: n.weekNumberDidMount, willUnmount: n.weekNumberWillUnmount }, t.children);
  });
};
function ec(t) {
  return t.text;
...
var xt = 10, tc = function(t) {
  ...
  return e.prototype.render = function() {
    ...
    return m(fe.Consumer, null, function(o) {
      var s = o.viewApi, l = o.options, c = o.calendarApi, u = l.moreLinkText, f = a.moreCnt, v = En(a), d = typeof u == "function" ? u.call(c, f) : "+" + f + " " + u, p = Me(l.moreLinkHint, [f], d), E = {
        num: f,
        shortText: "+" + f,
        text: d,
        view: s
      ...
      return m(
        B,
        null,
        Boolean(a.moreCnt) && m(Re, { elRef: r.linkElRef, hookProps: E, classNames: l.moreLinkClassNames, content: l.moreLinkContent, defaultContent: a.defaultContent || ac, didMount: l.moreLinkDidMount, willUnmount: l.moreLinkWillUnmount }, function(S, g, b, D) {
  ...
  return e.prototype.render = function() {
    ...
    return m(nc, { dateProfile: r.dateProfile, todayRange: r.todayRange, allDayDate: r.allDayDate, moreCnt: r.moreCnt, allSegs: a, hiddenSegs: i, alignmentElRef: r.alignmentElRef, alignGridTop: r.alignGridTop, extraDateSpan: r.extraDateSpan, popoverContent: function() {
      ...
      return m(B, null, a.map(function(s) {
        ...
        } }, Ga(s) ? m(Ya, h({ seg: s, isDragging: !1, isSelected: l === r.eventSelection, defaultDisplayEventEnd: !1 }, Ie(s, r.todayRange))) : m(qa, h({ seg: s, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: l === r.eventSelection, defaultDisplayEventEnd: !1 }, Ie(s, r.todayRange))));
      }));
...
function yc(t, e, r, n, a, i, o) {
  ...
  for (var p = s.addSegs(l), E = s.toRects(), S = Ec(E, t, o), g = S.singleColPlacements, b = S.multiColPlacements, D = S.leftoverMargins, C = [], k = [], T = 0, P = c; T < P.length; T++) {
    var f = P[T];
    b[f.firstCol].push({
      seg: f,
      isVisible: !1,
...
function Ec(t, e, r) {
  for (var n = Sc(t, r.length), a = [], i = [], o = [], s = 0; s < r.length; s += 1) {
    ...
    for (var g = 0, b = l; g < b.length; g++) {
      ...
      f += p.levelCoord - u, u = p.levelCoord + p.thickness, D ? (f += p.thickness, C && S.push({
    ...
    if (this.hiddenConsumes && l) {
      ...
      if (!s[f])
        if (this.allowReslicing) {
          var v = h(h({}, l), { span: Ia(l.span, n.span) }), d = Pe(v);
  ...
  return e.prototype.render = function() {
    ...
    return m(
      ...
      a.cells.map(function(D, C) {
        ...
        return m(mc, { key: D.key, elRef: r.cellElRefs.createRef(D.key), innerElRef: r.frameElRefs.createRef(D.key), dateProfile: a.dateProfile, date: D.date, showDayNumber: a.showDayNumbers, showWeekNumber: a.showWeekNumbers && C === 0, forceDayTop: a.showWeekNumbers, todayRange: a.todayRange, eventSelection: a.eventSelection, eventDrag: a.eventDrag, eventResize: a.eventResize, extraHookProps: D.extraHookProps, extraDataAttrs: D.extraDataAttrs, extraClassNames: D.extraClassNames, extraDateSpan: D.extraDateSpan, moreCnt: S[C], moreMarginTop: g[C], singlePlacements: p[C], fgContentElRef: r.fgElRefs.createRef(D.key), fgContent: m(
          ...
          r.renderFillSegs(c[C], "non-business"),
          r.renderFillSegs(u[C], "bg-event")
        ) });
      })
    );
  }, e.prototype.componentDidMount = function() {
    ...
    if (f)
      for (var E = 0, S = n; E < S.length; E++) {
        ...
        T && (c.isRtl ? (_ = 0, P = f.lefts[b.lastCol] - f.lefts[b.firstCol]) : (P = 0, _ = f.rights[b.firstCol] - f.rights[b.lastCol])), p.push(m("div", { className: "fc-daygrid-event-harness" + (T ? " fc-daygrid-event-harness-abs" : ""), key: C, ref: d ? null : this.segHarnessRefs.createRef(C), style: {
          visibility: k ? "" : "hidden",
          marginTop: T ? "" : g.marginTop,
          top: T ? g.absoluteTop : "",
          left: P,
          right: _
        } }, Ga(b) ? m(Ya, h({ seg: b, isDragging: o, isSelected: D === u, defaultDisplayEventEnd: v }, Ie(b, a))) : m(qa, h({ seg: b, isDragging: o, isResizing: s, isDateSelecting: l, isSelected: D === u, defaultDisplayEventEnd: v }, Ie(b, a)))));
      }
    return p;
    ...
    if (o)
      for (var l = 0, c = r; l < c.length; l++) {
        ...
        s.push(m("div", { key: Qo(u.eventRange), className: "fc-daygrid-bg-harness", style: f }, n === "bg-event" ? m(Ku, h({ seg: u }, Ie(u, i))) : $u(n)));
      }
          ...
          m(
            ...
            m("tbody", { role: "presentation" }, n.cells.map(function(D, C) {
              return m(ja, {
                ...
                businessHourSegs: c[C],
                eventSelection: n.eventSelection,
                bgEventSegs: u[C].filter(wc),
                fgEventSegs: f[C],
                dateSelectionSegs: v[C],
                eventDrag: d[C],
                eventResize: p[C],
                dayMaxEvents: o,
                dayMaxEventRows: i,
...
var Ja = function(t) {
  ...
  function e(r) {
    ...
    n.subjectEl = null, n.subjectSeg = null, n.isDragging = !1, n.eventRange = null, n.relevantEvents = null, n.receivingContext = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(l) {
      ...
      var D = f.isValidSegDownEl(c) && !V(c, ".fc-event-resizer");
      v.setIgnoreMove(!D), n.isDragging = D && l.subjectEl.classList.contains("fc-event-draggable");
    }, n.handleDragStart = function(l) {
      ...
      l.isTouch ? f !== n.component.props.eventSelection && c.dispatch({ type: "SELECT_EVENT", eventInstanceId: f }) : c.dispatch({ type: "UNSELECT_EVENT" }), n.isDragging && (c.calendarApi.unselect(l), c.emitter.trigger("eventDragStart", {
        el: n.subjectEl,
        event: new N(c, u.def, u.instance),
        jsEvent: l.origEvent,
        view: c.viewApi
      }));
    }, n.handleHitUpdate = function(l, c) {
      ...
      if (n.isDragging) {
        var c = n.component.context, u = c.viewApi, f = n, v = f.receivingContext, d = f.validMutation, p = n.eventRange.def, E = n.eventRange.instance, S = new N(c, p, E), g = n.relevantEvents, b = n.mutatedRelevantEvents, D = n.hitDragging.finalHit;
        if (n.clearDrag(), c.emitter.trigger("eventDragStop", {
          ...
          if (v === c) {
            var C = new N(c, b.defs[p.defId], E ? b.instances[E.instanceId] : null);
            c.dispatch({
              type: "MERGE_EVENTS",
              eventStore: b
            });
            ...
            }, T = {}, P = 0, _ = c.getCurrentData().pluginHooks.eventDropTransformers; P < _.length; P++) {
              var O = _[P];
              h(T, O(d, c));
            }
            c.emitter.trigger("eventDrop", h(h(h({}, k), T), { el: l.subjectEl, delta: d.datesDelta, jsEvent: l.origEvent, view: u })), c.emitter.trigger("eventChange", k);
          } else if (v) {
            var L = {
              event: S,
            ...
            var Z = b.defs[p.defId], z = b.instances[E.instanceId], Ue = new N(v, Z, z);
            v.dispatch({
              type: "MERGE_EVENTS",
              eventStore: b
            });
            ...
            }), v.emitter.trigger("drop", h(h({}, Ka(D.dateSpan, v)), { draggedEl: l.subjectEl, jsEvent: l.origEvent, view: D.context.viewApi })), v.emitter.trigger("eventReceive", h(h({}, Ve), { draggedEl: l.subjectEl, view: D.context.viewApi }));
          }
        } else
...
var Zc = function(t) {
  ...
  function e(r) {
    ...
    n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(s) {
      var l = n.component, c = n.querySegEl(s), u = Se(c), f = n.eventRange = u.eventRange;
      ...
      n.draggingSegEl = u, n.draggingSeg = Se(u), l.calendarApi.unselect(), l.emitter.trigger("eventResizeStart", {
        el: u,
        event: new N(l, c.def, c.instance),
        jsEvent: s.origEvent,
        view: l.viewApi
      });
      ...
      var l = n.component.context, c = n.eventRange.def, u = n.eventRange.instance, f = new N(l, c, u), v = n.relevantEvents, d = n.mutatedRelevantEvents;
      if (l.emitter.trigger("eventResizeStop", {
        ...
        var p = new N(l, d.defs[c.defId], u ? d.instances[u.instanceId] : null);
        l.dispatch({
          type: "MERGE_EVENTS",
          eventStore: d
        });
